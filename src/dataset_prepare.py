...
for i in tqdm(range(len(df))):
    ...
    if i < 28709:
        if df['emotion'][i] == 0:
            ...
            img.save('train/disgust/im'+str(disgusted)+'.png')
            disgusted += 1
        elif df['emotion'][i] == 2:
            img.save('train/fear/im'+str(fearful)+'.png')
            fearful += 1
        elif df['emotion'][i] == 3:
            ...
            img.save('train/surprise/im'+str(surprised)+'.png')
            surprised += 1
        elif df['emotion'][i] == 6:
    ...
    # test
        ...
        if df['emotion'][i] == 0:
            ...
            img.save('test/disgust/im'+str(disgusted_test)+'.png')
            disgusted_test += 1
        elif df['emotion'][i] == 2:
            img.save('test/fear/im'+str(fearful_test)+'.png')
            fearful_test += 1
        elif df['emotion'][i] == 3:
            ...
            img.save('test/surprise/im'+str(surprised_test)+'.png')
            surprised_test += 1
        elif df['emotion'][i] == 6:
